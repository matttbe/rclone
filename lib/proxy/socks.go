...
// It will optionally take a proxyDialer to dial the SOCKS5 proxy server. If nil is passed, it will use the default fshttp.Dialer.
func SOCKS5Dial(ctx context.Context, network, addr, socks5Proxy string, proxyDialer proxy.Dialer) (net.Conn, error) {
